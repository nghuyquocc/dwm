...
static const char *colors[][3] = {
    /*                fg          bg           border        */
    [SchemeNorm]     = { col_text,  col_base,     col_surface1 }, /* unfocused windows */
    [SchemeSel]      = { col_text,  col_base,     col_lavender }, /* focused windows (lavender border) */

    /* ---- Bar sections ---- */
    [SchemeStatus]   = { col_text,  col_base,     "#000000" },    /* right side: status text */
    [SchemeTagsNorm] = { col_text,  col_base,     "#000000" },    /* unselected tags */
    [SchemeTagsSel]  = { col_mantle, col_lavender,"#000000" },   /* selected tag (lavender bg, dark text) */
    [SchemeInfoNorm] = { col_text,  col_base,     "#000000" },    /* title (unselected) */
    [SchemeInfoSel]  = { col_text,  col_base,     "#000000" },    /* title (selected) */
};
...
static const char *dmenucmd[] = {
  ...
  "-nb", col_base,     "-nf", col_text,
  "-sb", col_lavender, "-sf", col_mantle,
  NULL
};
